...
<body>
	...
	<section class="container">
		...
		<div class="card bg-light mt-3">
			...
			<div class="card-body">
				<h5 class="card-title">
					정말 좋은 강의 입니다.&nbsp;<small>(2017가을 학기)</small>
				</h5>
				<p class="card-text">강의가 많이 널널해, 솔직히 많인 배운 건 없는 것 같지만 학점도 잘 나오고
					너무 좋은거같습니다.</p>
				<div class="row">
		...
		<div class="card bg-light mt-3">
			...
			<div class="card-body">
				<h5 class="card-title">
					정말 좋긴한데..&nbsp;<small>(2017가을 학기)</small>
				</h5>
				<p class="card-text">강의가 많이 널널해, 솔직히 많인 배운 건 없는 것 같지만 학점이 생각보다
					안나와 슬프.</p>
				<div class="row">
					<div class="col-9 text-left">
						성적<span style="color: red;">B</span> 널널<span style="color: red;">A</span>
						강의<span style="color: red;">B</span>
					</div>
					<div class="col-3 text-right">
						<a onclick="return confirm('추천하시겠습니까?')"
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="./evaluationRegisterAction.jsp" method="post">
					...
					<div class="form-group">
						<label>내용</label>
						<textarea textarea name="evaluationContent" class="form-control"
							maxlength="2048" style="height: 180px;"></textarea>
					</div>
					<!-- 하나의 행을 여러개로 나눌 때 row를 사용한다. -->
					<div class="form-row">
						<div class="form-group col-sm-3">
							<label>종합</label> <select name="tootalScore" class="form-control">
						...
						<div class="form-group col-sm-3">
							<label>성적</label> <select name=creditScore " class="form-control">
								<option value="A" selected>A</option>
								<option value="B">B</option>
								<option value="C">C</option>
								<option value="D">D</option>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="./reportAction.jsp" method="post">
					...
					<div class="form-group">
						<label>신고 내용</label>
						<textarea textarea name="reportContent" class="form-control"
							maxlength="2048" style="height: 180px;"></textarea>
					</div>
